...
export default function NavBar() {
  ...
  return (
    <nav className="fixed inset-0 flex justify-center sm:px-8">
      <div className="flex w-full max-w-7xl lg:px-8">
        ...
        <button
          ...
          onClick={() =>
            showOnLg == "" ? setShowOnLg("show") : setShowOnLg("")
          }
        >
          <span className="navbar-toggler-icon"></span>
        </button>
        <div
          className={`collapse navbar-collapse ${showOnLg}`}
          id="navbarToggler"
        >
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              ...
              >
                {" "}
                <i className="bi bi-file-pdf"></i>Download Resume
              </a>
            </li>
          </ul>
        </div>
